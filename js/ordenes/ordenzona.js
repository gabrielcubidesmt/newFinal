...
function listar() {
    $.ajax({
        ...
        // prod test
        url: `http://155.248.195.17:8080/api/order/zona/${userZona}`,
        type: "GET",
        dataType: "json",
...
function detalleOrden(indice) {
    ...
    let tablaProductos = tabla + `<table class='table table-dark table-hover'>
                <thead>
                  <tr>
                    <th>Referencia</th>
                    <th>Categoría</th>
...
function actualizarEstadoOrden(){
    ...
    $.ajax({
        ...
        // prod test
        url: `http://155.248.195.17:8080/api/order/update`,
        data: datosPeticion,
        type: 'PUT',
